...
void UP_Woody_ImageRecHSISet(u32 HMax,u32 HMin,u32 SMax,u32 SMin,u32 IMax,u32 IMin){
	u32 sum=0x55+0xaa+0x0D+0x33;
	UP_UART5_Putc(0x55);
	UP_UART5_Putc(0xaa);
	UP_UART5_Putc(0x0D);
	UP_UART5_Putc(0x33);
	UP_UART5_Putc(HMax);sum+=HMax;
	UP_UART5_Putc(HMin);sum+=HMin;
	UP_UART5_Putc(SMax);sum+=SMax;
	UP_UART5_Putc(SMin);sum+=SMin;
	UP_UART5_Putc(IMax);sum+=IMax;
	UP_UART5_Putc(IMin);sum+=IMin;
	UP_UART5_Putc(sum);
}
