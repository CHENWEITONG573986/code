...
int main()
{
    ...
    RC[71][72] = 1, RC[71][74] = 1, RC[72][73] = 1, RC[73][74] = 1, RC[74][1] = 1, RC[74][80] = 1, RC[75][76] = 1, RC[76][77] = 1, RC[77][78] = 1, RC[77][19] = 1, RC[78][79] = 1, RC[79][80] = 1;
    // for (int i = 1; i < 81; i++)
    //     FindRoadAll(i);
    FindRoadAll(2);
    int MIN, temp;
